          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#ffffff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
            <tr>
              <td style="padding:24px 28px 0;">
                <p style="margin:0;font-size:12px;letter-spacing:0.18em;text-transform:uppercase;color:#0d7a63;">Introw</p>
            ...
            <tr>
              <td style="padding:16px 28px 0;">
                <p style="margin:0;font-size:15px;line-height:1.6;color:#475569;">
                  Hi ${escapeHtml(name)}, we received a request to reset your Introw password.
